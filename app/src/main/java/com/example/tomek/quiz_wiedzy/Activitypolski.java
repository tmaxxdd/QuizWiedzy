...
public class Activitypolski extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.polski_layout);
    ...
    public void onClick(View v) {
        ...
        switch (checked2) {
            case R.id.radio2_1:
                radio2_1.setText("Dobra odpowiedź");
                b = 1;
        ...
        switch (checked7) {
            ...
            case R.id.radio7_3:
                radio7_3.setText("Dobra odpowiedź");
                g = 1;
                radio7_2.setEnabled(false);
                radio7_1.setEnabled(false);
                break;
        ...
        switch (checked9) {
            ...
            case R.id.radio9_3:
                radio9_3.setText("Dobra odpowiedź");
                i = 1;
                radio9_2.setEnabled(false);
                radio9_1.setEnabled(false);
                break;
        ...
        switch (checked13) {
            ...
            case R.id.radio13_2:
                radio13_2.setText("Zła odpowiedź");
                radio13_1.setEnabled(false);
                radio13_3.setEnabled(false);
                break;

            case R.id.radio13_3:
                radio13_3.setText("Dobra odpowiedź");
                m = 1;
                radio13_2.setEnabled(false);
                radio13_1.setEnabled(false);
                break;
        ...
        switch (checked15) {
            ...
            case R.id.radio15_2:
                radio15_2.setText("Dobra odpowiedź");
                o = 1;
                radio15_3.setEnabled(false);
        ...
        switch (checked18) {
            ...
            case R.id.radio18_2:
                radio18_2.setText("Dobra odpowiedź");
                r = 1;
        ...
        switch (checked19) {
            ...
            case R.id.radio19_2:
                radio19_2.setText("Dobra odpowiedź");
                s = 1;
        ...
        switch (checked20) {
            ...
            case R.id.radio20_3:
                radio20_3.setText("Dobra odpowiedź");
                t = 1;
                radio20_2.setEnabled(false);
                radio20_1.setEnabled(false);
                break;
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activitypolski.this,MainActivity.class);
                Activitypolski.this.startActivity(i);
            }
        });
