...
public class Activitygeografia extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.geografia_layout);
    ...
    public void onClick(View v) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activitygeografia.this,MainActivity.class);
                Activitygeografia.this.startActivity(i);
            }
        });
