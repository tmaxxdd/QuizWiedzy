...
public class Activityhistoria extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (checked5) {
            ...
            case R.id.radio5_2:
                radio5_2.setText("Dobra odpowiedź");
                e = 1;
        ...
        switch (checked6) {
            ...
            case R.id.radio6_1:
                radio6_1.setText("Dobra odpowiedź");
                f = 1;
            ...
            case R.id.radio6_2:
                radio6_2.setText("Zła odpowiedź");
                radio6_3.setEnabled(false);
        ...
        switch (checked10) {
            ...
            case R.id.radio10_2:
                radio10_2.setText("Dobra odpowiedź");
                j = 1;
        ...
        switch (checked11) {
            ...
            case R.id.radio11_3:
                radio11_3.setText("Dobra odpowiedź");
                k = 1;
                radio11_2.setEnabled(false);
                radio11_1.setEnabled(false);
                break;
        ...
        switch (checked17) {
            ...
            case R.id.radio17_2:
                radio17_2.setText("Dobra odpowiedź");
                p = 1;
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityhistoria.this,MainActivity.class);
                Activityhistoria.this.startActivity(i);
            }
        });
