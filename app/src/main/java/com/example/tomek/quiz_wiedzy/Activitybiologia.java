...
public class Activitybiologia extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.biologia_layout);
    ...
    public void onClick(View v) {
        ...
        switch (checked2) {
            case R.id.radio2_1:
                ...
                break;
            case R.id.radio2_2:
                radio2_2.setText("Zła odpowiedź");
                radio2_1.setEnabled(false);
                radio2_3.setEnabled(false);
                break;

            case R.id.radio2_3:
                radio2_3.setText("Dobra odpowiedź");
                b = 1;
                radio2_2.setEnabled(false);
                radio2_1.setEnabled(false);
                break;
        ...
        switch (checked4) {
            ...
            case R.id.radio4_1:
                radio4_1.setText("Zła odpowiedź");
                radio4_2.setEnabled(false);
                radio4_3.setEnabled(false);
                break;

            case R.id.radio4_2:
                radio4_2.setText("Dobra odpowiedź");
                d = 1;
        ...
        switch (checked5) {
            ...
            case R.id.radio5_1:
                radio5_1.setText("Dobra odpowiedź");
                e = 1;
            ...
            case R.id.radio5_3:
                radio5_3.setText("Zła odpowiedź");
                radio5_2.setEnabled(false);
                radio5_1.setEnabled(false);
                break;
        }
        ...
        switch (checked7) {
            ...
            case R.id.radio7_1:
                radio7_1.setText("Dobra odpowiedź");
                g = 1;
            ...
            case R.id.radio7_2:
                radio7_2.setText("Zła odpowiedź");
                radio7_3.setEnabled(false);
        ...
        switch (checked8) {
            ...
            case R.id.radio8_1:
                radio8_1.setText("Zła odpowiedź");
            ...
            case R.id.radio8_3:
                radio8_3.setText("Dobra odpowiedź");
                h = 1;
                radio8_2.setEnabled(false);
                radio8_1.setEnabled(false);
                break;
        ...
        switch (checked9) {
            ...
            case R.id.radio9_1:
                radio9_1.setText("Zła odpowiedź");
                radio9_2.setEnabled(false);
                radio9_3.setEnabled(false);
                break;

            case R.id.radio9_2:
                radio9_2.setText("Dobra odpowiedź");
                i = 1;
                radio9_3.setEnabled(false);
        ...
        switch (checked10) {
            ...
            case R.id.radio10_1:
                radio10_1.setText("Dobra odpowiedź");
                j = 1;
            ...
            case R.id.radio10_3:
                radio10_3.setText("Zła odpowiedź");
                radio10_2.setEnabled(false);
                radio10_1.setEnabled(false);
                break;
        }
        ...
        switch (checked11) {
            ...
            case R.id.radio11_1:
                radio11_1.setText("Dobra odpowiedź");
                k = 1;
            ...
            case R.id.radio11_2:
                radio11_2.setText("Zła odpowiedź");
        ...
        switch (checked12) {
            ...
            case R.id.radio12_1:
                radio12_1.setText("Zła odpowiedź");
                radio12_2.setEnabled(false);
                radio12_3.setEnabled(false);
                break;

            case R.id.radio12_2:
                radio12_2.setText("Dobra odpowiedź");
                l = 1;
                radio12_3.setEnabled(false);
        ...
        switch (checked15) {
            ...
            case R.id.radio15_1:
                radio15_1.setText("Dobra odpowiedź");
                o = 1;
            ...
            case R.id.radio15_3:
                radio15_3.setText("Zła odpowiedź");
                radio15_2.setEnabled(false);
                radio15_1.setEnabled(false);
                break;
        }
        ...
        switch (checked16) {
            ...
            case R.id.radio16_1:
                radio16_1.setText("Zła odpowiedź");
                radio16_2.setEnabled(false);
                radio16_3.setEnabled(false);
                break;

            case R.id.radio16_2:
                radio16_2.setText("Dobra odpowiedź");
                u = 1;
        ...
        switch (checked17) {
            ...
            case R.id.radio17_1:
                radio17_1.setText("Dobra odpowiedź");
                p = 1;
        ...
        switch (checked18) {
            ...
            case R.id.radio18_1:
                radio18_1.setText("Zła odpowiedź");
            ...
            case R.id.radio18_3:
                radio18_3.setText("Dobra odpowiedź");
                r = 1;
                radio18_2.setEnabled(false);
                radio18_1.setEnabled(false);
                break;
        ...
        switch (checked19) {
            ...
            case R.id.radio19_1:
                radio19_1.setText("Zła odpowiedź");
            ...
            case R.id.radio19_3:
                radio19_3.setText("Dobra odpowiedź");
                s = 1;
                radio19_2.setEnabled(false);
                radio19_1.setEnabled(false);
                break;
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inte = new Intent(Activitybiologia.this, MainActivity.class);
                Activitybiologia.this.startActivity(inte);
            }
        });
