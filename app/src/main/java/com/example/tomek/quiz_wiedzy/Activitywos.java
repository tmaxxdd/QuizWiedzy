...
public class Activitywos extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wos_layout);
    ...
    public void onClick(View v) {
        ...
        switch (checked3) {
            ...
            case R.id.radio3_2:
                radio3_2.setText("Dobra odpowiedź");
                c = 1;
                radio3_3.setEnabled(false);
            ...
            case R.id.radio3_3:
                radio3_3.setText("Zła odpowiedź");
                radio3_2.setEnabled(false);
                radio3_1.setEnabled(false);
                break;
        }
        ...
        switch (checked4) {
            ...
            case R.id.radio4_3:
                radio4_3.setText("Dobra odpowiedź");
                d = 1;
                radio4_2.setEnabled(false);
                radio4_1.setEnabled(false);
                break;
        ...
        switch (checked12) {
            ...
            case R.id.radio12_3:
                radio12_3.setText("Dobra odpowiedź");
                l = 1;
                radio12_2.setEnabled(false);
                radio12_1.setEnabled(false);
                break;
        ...
        switch (checked14) {
            ...
            case R.id.radio14_1:
                radio14_1.setText("Dobra odpowiedź");
                n = 1;
            ...
            case R.id.radio14_3:
                radio14_3.setText("Zła odpowiedź");
                radio14_2.setEnabled(false);
                radio14_1.setEnabled(false);
                break;
        }
        ...
        switch (checked20) {
            ...
            case R.id.radio20_1:
                radio20_1.setText("Zła odpowiedź");
                radio20_2.setEnabled(false);
                radio20_3.setEnabled(false);
                break;

            case R.id.radio20_2:
                radio20_2.setText("Dobra odpowiedź");
                t = 1;
                radio20_3.setEnabled(false);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activitywos.this,MainActivity.class);
                Activitywos.this.startActivity(i);
            }
        });
